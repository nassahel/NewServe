...
const SectionTree = () => {
  ...
  return (
    <div className='flex items-center justify-center py-20 lg:py-20 relative overflow-hidden '>
      ...
      <div className=' flex flex-col items-center justify-center w-11/12 lg:w-10/12 rounded py-10 lg:px-20 shadow-mg'>
        ...
        <motion.div
         ...
         transition={{ duration: .4, delay: .1}}
          className='text-3xl font-semibold mb-20 text-azulServe text-center bg-white py-6 w-11/12 lg:w-6/12 rounded shadow-lg'>
        ...
        <div className='w-full flex flex-col lg:flex-row items-center relative justify-evenly gap-10'>
          {
            clientes.map((cliente, index) => (
              <motion.figure
                ...
                viewport={{ once: true }}
                key={index}
                className='flex bg-white items-center justify-center shadow-lg rounded hover:shadow-md duration-200  w-80 p-6 h-64'>
