...
const SectionTwo = () => {
  ...
  return (
    <div id='sectionTwo' className='flex flex-col gap-28 py-36  items-center'>
      <motion.div
        initial={{ opacity: 0 }}
        ...
        <img className='h-[25rem] w-[40rem] object-cover shadow-md' src={manteAsistencia} alt="imagen ilustrativa: hombre realizando mantenimiento de maquina hidrulica" />
      </motion.div>
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className='flex flex-col lg:flex-row justify-between w-9/12 border-b pb-20'>
        <img className='h-[25rem] w-[40rem] object-cover shadow-md' src={plc} alt="imágen ilustrativa: laptop conectada a una maquina en reparación" />
        <div className='flex flex-col gap-10'>
      ...
      <motion.div
        ...
        <img className='h-[25rem] w-[40rem] object-cover shadow-md' src={comprInd} alt="imágen ilustrativa: bomba de agua" />
      </motion.div>
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className='flex flex-col lg:flex-row justify-between w-9/12 border-b pb-20'>
        <img className='h-[25rem] w-[40rem] object-cover shadow-md' src={manteEdilicio} alt="imagen ilustrativa: obreros trabajando en construcción de un edificio" />
        <div className='flex flex-col gap-10'>
      ...
      <motion.div
        ...
        <img className='h-[25rem] w-[40rem] object-cover shadow-md' src={divElectrica} alt="imagen ilustrativa: persona controlando un tablero eléctrico" />
      </motion.div>
